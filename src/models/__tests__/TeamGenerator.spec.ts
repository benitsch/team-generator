...
class BalancedRandomTeamGeneratorUnderTest extends BalancedRandomTeamGenerator {
  ...
  public orderPlayersDescendingByGameSkill(
    players: Player[],
    game: Game,
  ): Player[] {
  ...
  public assignPlayersToTeams(
    orderedPlayerArray: Player[],
    teamSize: number,
    game: Game,
  ): [Team[], Team] {
...
describe('BalancedRandomTeamGeneratorInterfaceTest', () => {
  ...
  it('Shall not accept invalid input.', () => {
    ...
    const generateResult: Array<Team> | GeneratorErrorCode = generator.generate(
      players,
      teamSize,
      game,
    );
...
describe('BalancedRandomTeamGeneratorClassTest', () => {
  ...
  const generator: BalancedRandomTeamGeneratorUnderTest =
    new BalancedRandomTeamGeneratorUnderTest(instance(mockRandomSource));
  ...
  it('Shall not accept duplicate players at input validation.', () => {
    ...
    const generateResult: GeneratorErrorCode | undefined =
      generator.validateGeneratorInput(players, teamSize, game);
  ...
  it('Shall not accept too few players at input validation (at least two teams must be creatable!).', () => {
    ...
    expect(errorCode).toEqual(
      GeneratorErrorCode.TeamSizeAndPlayerLengthMismatch,
    );
  });
  ...
  it('Shall not swap players between 2 teams if skill diff is less or equal to 1', () => {
    ...
    const swapSuccess: boolean = generator.trySwapPlayerForBetterBalance(
      team1,
      team2,
    );
